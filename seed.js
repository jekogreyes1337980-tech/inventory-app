...
const DEFAULT_PRODUCTS = [
  { id: "prod-1", name: "Cartolina Roll (Red)", category: "Raw Materials", unit: "rolls/meters", stockRoomQty: 25, storefrontQty: 5, threshold: 10, racks: ["Rack A-1"], cost: 15.00, price: 25.00, rollLengthMeters: 10, convertedStock: 0 },
  { id: "prod-2", name: "Foil Wrap (Silver)", category: "Raw Materials", unit: "rolls/meters", stockRoomQty: 40, storefrontQty: 2, threshold: 8, racks: ["Rack A-2"], cost: 30.00, price: 50.00, rollLengthMeters: 20, convertedStock: 0 },
  ...
  { id: "prod-4", name: "Pilot G2 Gel Pen (Black)", category: "Finished Goods", unit: "pcs", stockRoomQty: 200, storefrontQty: 30, threshold: 40, racks: ["Rack C-1"], cost: 45.00, price: 65.00, rollLengthMeters: 0, convertedStock: 0 },
  { id: "prod-5", name: "Double Sided Tape 1-inch", category: "Consumables", unit: "pcs", stockRoomQty: 50, storefrontQty: 8, threshold: 12, racks: ["Rack C-2"], cost: 20.00, price: 35.00, rollLengthMeters: 0, convertedStock: 0 }
];
